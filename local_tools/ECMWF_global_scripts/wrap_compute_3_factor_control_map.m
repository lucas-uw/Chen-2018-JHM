...
%load('../../ERA_Interim_latlon_data.mat');
...
subplot(2,1,1);
pcolor(lons, lats, control_map_annual);
caxis([0.5 3.5]);
colormap(parula(3));
shading flat;
ax = gca;
...
subplot(4,2,5);
pcolor(lons, lats, control_map_spring);
caxis([0.5 3.5]);
colormap(parula(3));
shading flat;
ax = gca;
...
subplot(4,2,6);
pcolor(lons, lats, control_map_summer);
caxis([0.5 3.5]);
colormap(parula(3));
shading flat;
ax = gca;
...
subplot(4,2,7);
pcolor(lons, lats, control_map_fall);
caxis([0.5 3.5]);
colormap(parula(3));
shading flat;
ax = gca;
...
subplot(4,2,8);
pcolor(lons, lats, control_map_winter);
caxis([0.5 3.5]);
colormap(parula(3));
shading flat;
ax = gca;
