...
%    end
%end
%save('/civil/shared/ganges/xiaodc/lulcc/data/reanalysis_data/NARR/cape/cape_percentile.mat', '-v7.3', 'cape_percentile');
%
%
%%% PW
%clear all;
...
%    end
%end
%save('/civil/shared/ganges/xiaodc/lulcc/data/reanalysis_data/NARR/pw/pw_percentile.mat', '-v7.3', 'pw_percentile');
%
%
%%% wind
%clear all;
...
%    end
%end
%save('/civil/shared/ganges/xiaodc/lulcc/data/reanalysis_data/NARR/wind/wind_percentile.mat', '-v7.3', 'wind_percentile');
%
%
%%% RH
%clear all;
...
%    end
%end
%save('/civil/shared/ganges/xiaodc/lulcc/data/reanalysis_data/NARR/rh/rh_percentile.mat', '-v7.3', 'rh_percentile');
%
%
%%% Tavg
clear all;
...
save('/civil/shared/ganges/xiaodc/lulcc/data/reanalysis_data/NARR/tavg/tavg_percentile.mat', '-v7.3', 'tavg_percentile');
%
%%% Tdiff
%clear all;
%clc;
...
%    end
%end
%save('/civil/shared/ganges/xiaodc/lulcc/data/reanalysis_data/NARR/tdiff/tdiff_percentile.mat', '-v7.3', 'tdiff_percentile');
