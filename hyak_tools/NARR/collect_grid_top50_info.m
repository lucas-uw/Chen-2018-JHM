...
for i=1:nx
    ...
    for j=1:ny
        ...
        [tmp_amount, tmp_index] = sort(squeeze(prec3_72cum(:,i,j)), 'descend');
...
save('/civil/shared/ganges/xiaodc/lulcc/data/reanalysis_data/NARR/prec/grid_analysis/yearround_max50_info.mat', '-v7.3', 'max_50_info');
